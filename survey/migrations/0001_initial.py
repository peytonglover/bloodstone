    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('results', models.ManyToManyField(related_name='survey_result', to='survey.Result')),
            ],
        ),
        migrations.AddField(
            model_name='question',
        ...
        migrations.AddField(
            model_name='choice',
            name='question',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='question_choice', to='survey.question'),
        ),
    ]
